...
values
  ('Red Leopard Skin Jasper Bracelet III (6mm)', 'red-leopard-skin-jasper-bracelet-iii', 'Earthy and grounding hand-finished bracelet.', 'JQJ-RLSJ-III', 599.99, 699.99, (select id from categories where slug='bracelets'), array['/products/red-leopard-jasper-bracelet.webp','/products/lifestyle.webp'], 12, 5, 4.8, 28, array['top-rated','sale'], 'Carnelian', array['Hand-made for your wrist size'], '{"Bead Size":"6mm","Stone":"Red Leopard Skin Jasper"}'),
  ('Raw Brown Tourmaline Bracelet I (8-10mm)', 'raw-brown-tourmaline-bracelet-i', 'Raw untreated brown tourmaline nuggets.', 'JQJ-TOURM-I', 368.99, null, (select id from categories where slug='bracelets'), array['/products/brown-tourmaline-bracelet.webp'], 8, 5, 4.7, 19, array['new'], 'Tourmaline', array['Hand-made for your wrist size'], '{"Bead Size":"8-10mm","Stone":"Raw Brown Tourmaline"}'),
  ('Sodalite Bracelet VIII (4mm)', 'sodalite-bracelet-viii', 'Deep blue sodalite with silver accents.', 'JQJ-SOD-VIII', 549.99, null, (select id from categories where slug='bracelets'), array['/products/sodalite-bracelet.webp'], 15, 5, 4.9, 41, array['top-rated'], 'Sodalite', array['Hand-made for your wrist size'], '{"Bead Size":"4mm","Stone":"Sodalite"}'),
  ...
  ('Silver Bracelet IV (4mm)', 'silver-bracelet-iv', 'A modern essential with polished beads.', 'JQJ-SIL-IV', 449.99, 499.99, (select id from categories where slug='bracelets'), array['/products/silver-bracelet.webp'], 9, 5, 4.8, 26, array['restocked','sale'], 'Tiger Eye', array['Hand-made for your wrist size'], '{"Bead Size":"4mm","Stone":"Hematite Silver"}'),
  ('Labradorite Bracelet V (8mm)', 'labradorite-bracelet-v', 'Iridescent labradorite with blue-gold flash.', 'JQJ-LABR-V', 519.99, null, (select id from categories where slug='bracelets'), array['/products/labradorite-bracelet.webp'], 6, 5, 4.9, 22, array['limited'], 'Lapis Lazuli', array['Hand-made for your wrist size'], '{"Bead Size":"8mm","Stone":"Labradorite"}'),
  ...
  ('Labradorite Silver Pendant', 'labradorite-silver-pendant', 'Faceted labradorite baton framed in silver.', 'JQJ-LABPEN', 279.99, null, (select id from categories where slug='necklaces'), array['/products/labradorite-pendant.webp'], 11, 5, 4.8, 17, array['restocked'], 'Lapis Lazuli', array['Hand-made'], '{"Chain Length":"55cm","Stone":"Labradorite"}'),
  ('Pearl - Silver Necklace V (7mm)', 'pearl-silver-necklace-v', 'Freshwater pearls with silver-tone hematite.', 'JQJ-PEARL-V', 980.00, null, (select id from categories where slug='necklaces'), array['/products/pearl-silver-necklace.webp'], 5, 5, 4.9, 9, array['limited','top-rated'], 'Tiger Eye', array['Hand-made'], '{"Bead Size":"7mm","Stone":"Freshwater Pearl"}')
on conflict (slug) do nothing;
